...
def op(pyDir, PD):
    ...
    if SSn == 1:
        nS = 20 #override to examine only first degree of freedom
        cm = [0,20,40,60,80,100,120,140,160,180,200,220,240,260,280,300,320,340,360,380]
    ...
    np.save(os.path.join(outDir, 'PD_%s_SS%s_dist.npy' % (PD,SSn)), D)
